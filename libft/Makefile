...
ft_tolower.c ft_toupper.c ft_memset.c ft_memcpy.c ft_bzero.c \
ft_memchr.c ft_memmove.c ft_strchr.c ft_strrchr.c ft_memcmp.c \
ft_strnstr.c ft_strdup.c ft_substr.c ft_strjoin.c ft_strtrim.c \
ft_calloc.c ft_split.c ft_itoa.c ft_strmapi.c ft_striteri.c \
